          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                Turn listings into sales with our innovative real estate marketing system. 
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-yellow-900/30 to-orange-900/30 backdrop-blur-sm border border-yellow-500/30 rounded-3xl p-8">
                <h3 className="text-2xl font-bold mb-6">Real Estate Goals</h3>
                <div className="space-y-6">
                  <div className="flex items-center justify-between">
                    <span className="text-gray-300">Target Days on Market</span>
                    <span className="text-3xl font-bold text-yellow-400">18</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-300">Above Asking Price Goal</span>
                    <span className="text-3xl font-bold text-orange-400">15%</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-300">Lead Conversion Target</span>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              What we aim to achieve for real estate professionals
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-yellow-900/30 to-orange-900/30 border border-yellow-500/30 rounded-3xl p-8 text-center">
              <div className="text-4xl font-black mb-2 text-yellow-400">7 Days</div>
              <div className="text-gray-300 mb-4">Luxury Home Sale Goal</div>
              <p className="text-sm text-gray-400">"₹2.3Cr property sold in one week, above asking"</p>
            </div>
            <div className="bg-gradient-to-br from-orange-900/30 to-red-900/30 border border-orange-500/30 rounded-3xl p-8 text-center">
              <div className="text-4xl font-black mb-2 text-orange-400">25%</div>
              <div className="text-gray-300 mb-4">Above Market Value Target</div>
              <p className="text-sm text-gray-400">"Consistently selling properties above market price"</p>
            </div>
            <div className="bg-gradient-to-br from-red-900/30 to-pink-900/30 border border-red-500/30 rounded-3xl p-8 text-center">
              <div className="text-4xl font-black mb-2 text-red-400">95%</div>
              <div className="text-gray-300 mb-4">Client Satisfaction Goal</div>
              <p className="text-sm text-gray-400">"Building lasting relationships with agents and clients"</p>
            </div>
          </div>
        </div>
      </section>
