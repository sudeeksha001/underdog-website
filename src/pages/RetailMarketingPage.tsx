    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-800 text-white pt-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                Turn foot traffic into loyal customers with our innovative retail marketing strategies. 
            ...
            <div className="relative">
              <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-3xl p-8">
                <h3 className="text-2xl font-bold mb-6">Our Retail Goals</h3>
                <div className="space-y-6">
                  <div className="flex items-center justify-between">
                    <span className="text-gray-300">Target Foot Traffic Increase</span>
                    <span className="text-3xl font-bold">300%</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-300">Sales Conversion Goal</span>
                    <span className="text-3xl font-bold">85%</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-300">Customer Retention Target</span>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Our innovative 5-step methodology transforms struggling stores into customer magnets
            </p>
          </div>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Our Vision for Your Store
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              What we aim to achieve for retail businesses like yours
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700 rounded-3xl p-8 text-center">
              ...
              <div className="text-gray-300 mb-4">Target Foot Traffic Growth</div>
              <p className="text-sm text-gray-400">"Transform empty stores into bustling destinations"</p>
            </div>
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700 rounded-3xl p-8 text-center">
              <div className="text-4xl font-black mb-2">₹4L</div>
              <div className="text-gray-300 mb-4">Monthly Revenue Goal</div>
              <p className="text-sm text-gray-400">"Strategic investment in your store's future"</p>
            </div>
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700 rounded-3xl p-8 text-center">
              <div className="text-4xl font-black mb-2">92%</div>
              <div className="text-gray-300 mb-4">Customer Satisfaction Target</div>
              <p className="text-sm text-gray-400">"Create experiences customers love and remember"</p>
            </div>
          </div>
        </div>
      </section>
