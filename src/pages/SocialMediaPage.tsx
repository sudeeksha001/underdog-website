    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-800 text-white pt-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-cyan-900/30 to-purple-900/30 backdrop-blur-sm border border-cyan-500/30 rounded-3xl p-8">
                <h3 className="text-2xl font-bold mb-6">Social Media Goals</h3>
                <div className="space-y-6">
                  <div className="flex items-center justify-between">
                    <span className="text-gray-300">Follower Growth Target</span>
                    <span className="text-3xl font-bold text-cyan-400">450%</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-300">Engagement Rate Goal</span>
                    <span className="text-3xl font-bold text-purple-400">8.9%</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-300">Social Commerce Target</span>
                    <span className="text-3xl font-bold text-cyan-400">₹10L</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Our Social Media Vision
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              What we aim to achieve for social media marketing
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-cyan-900/30 to-purple-900/30 border border-cyan-500/30 rounded-3xl p-8 text-center">
              <div className="text-4xl font-black mb-2 text-cyan-400">25L</div>
              <div className="text-gray-300 mb-4">Followers Growth Goal</div>
              <p className="text-sm text-gray-400">"Build massive engaged communities"</p>
            </div>
            <div className="bg-gradient-to-br from-purple-900/30 to-pink-900/30 border border-purple-500/30 rounded-3xl p-8 text-center">
              ...
              <div className="text-gray-300 mb-4">Engagement Target</div>
            ...
            <div className="bg-gradient-to-br from-pink-900/30 to-red-900/30 border border-pink-500/30 rounded-3xl p-8 text-center">
              <div className="text-4xl font-black mb-2 text-pink-400">₹40L</div>
              <div className="text-gray-300 mb-4">Social Commerce Goal</div>
