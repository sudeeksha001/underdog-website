          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-pink-900/30 to-purple-900/30 backdrop-blur-sm border border-pink-500/30 rounded-3xl p-8">
                <h3 className="text-2xl font-bold mb-6">Brand Impact Goals</h3>
                <div className="space-y-6">
                  <div className="flex items-center justify-between">
                    <span className="text-gray-300">Brand Recognition Target</span>
                    <span className="text-3xl font-bold text-pink-400">400%</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-300">Customer Loyalty Goal</span>
                    <span className="text-3xl font-bold text-purple-400">89%</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-300">Premium Pricing Target</span>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              What we aim to achieve for brands across industries
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-pink-900/30 to-purple-900/30 border border-pink-500/30 rounded-3xl p-8 text-center">
              ...
              <div className="text-gray-300 mb-4">Brand Recognition Goal</div>
              <p className="text-sm text-gray-400">"Make brands instantly recognizable everywhere"</p>
            </div>
            <div className="bg-gradient-to-br from-purple-900/30 to-indigo-900/30 border border-purple-500/30 rounded-3xl p-8 text-center">
              ...
              <div className="text-gray-300 mb-4">Customer Engagement Target</div>
              <p className="text-sm text-gray-400">"Build communities that love your brand"</p>
            </div>
            <div className="bg-gradient-to-br from-indigo-900/30 to-blue-900/30 border border-indigo-500/30 rounded-3xl p-8 text-center">
              ...
              <div className="text-gray-300 mb-4">Premium Pricing Goal</div>
              <p className="text-sm text-gray-400">"Enable brands to charge premium prices"</p>
            </div>
          </div>
        </div>
      </section>
