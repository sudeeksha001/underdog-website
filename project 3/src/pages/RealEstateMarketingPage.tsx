    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-800 text-white pt-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-yellow-900/30 to-orange-900/30 backdrop-blur-sm border border-yellow-500/30 rounded-3xl p-8">
                <h3 className="text-2xl font-bold mb-6">Real Estate Results</h3>
                <div className="space-y-6">
                  <div className="flex items-center justify-between">
                    <span className="text-gray-300">Average Days on Market</span>
                    <span className="text-3xl font-bold text-yellow-400">18</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-300">Above Asking Price</span>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Properties That Sold Fast
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Real results from real estate professionals who trust our marketing system
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-yellow-900/30 to-orange-900/30 border border-yellow-500/30 rounded-3xl p-8 text-center">
              ...
              <div className="text-gray-300 mb-4">Luxury Home Sale</div>
              <p className="text-sm text-gray-400">"$2.8M property sold in one week, 12% above asking"</p>
            </div>
            <div className="bg-gradient-to-br from-orange-900/30 to-red-900/30 border border-orange-500/30 rounded-3xl p-8 text-center">
              ...
              <div className="text-gray-300 mb-4">Above Market Value</div>
            ...
            <div className="bg-gradient-to-br from-red-900/30 to-pink-900/30 border border-red-500/30 rounded-3xl p-8 text-center">
              ...
              <div className="text-gray-300 mb-4">Client Satisfaction</div>
              <p className="text-sm text-gray-400">"Agents love our results and refer us constantly"</p>
            </div>
          </div>
        </div>
      </section>
